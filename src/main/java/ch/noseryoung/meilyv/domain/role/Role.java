...
@Entity
@Table(name = "role")
public class Role extends ExtendedAuditEntity {
    ...
    @JoinTable(
            ...
            joinColumns = @JoinColumn(name = "role_id", referencedColumnName = "id", updatable = false, nullable = false),
            inverseJoinColumns = @JoinColumn(name = "authority_id", referencedColumnName = "id", updatable = false, nullable = false)
    )
